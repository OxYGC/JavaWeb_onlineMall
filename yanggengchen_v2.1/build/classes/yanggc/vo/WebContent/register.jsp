	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form class="form-horizontal" action="${pageContext.request.contextPath }/user?method=regist"  method="post"  style="margin-top: 5px;">
...
$(function(){
	...
	$("#username").blur(function(){
		...
		if(vv!=""){
			//向服务端发起Ajax请求
			$.post("${pageContext.request.contextPath}/RegisterVerifyServlet",{"um":vv},function(data){
				//alert(data);
				//$("#msg").html(data);
				if(data=="success"){
					$("#msg").html("用户名可以注册");
