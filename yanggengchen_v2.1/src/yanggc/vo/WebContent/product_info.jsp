...
<script type="text/javascript">
	...
	function addProductToCart(){
		...
		location.href="${pageContext.request.contextPath }/cart?method=addProductToCart&pid=${product.pid}&count="+count;
	}
	...
	<div class="container">
		<div class="row">
			<div
				...
				<a href="${pageContext.request.contextPath }/product?method=findByPage&cid=${product.category.cid}">${product.category.cname }&nbsp;&nbsp;&gt;</a>
				<a>${product.pname}</a>
			</div>
				...
				<div class="col-md-6">
					...
					<div
						...
						<div style="margin: 20px 0 10px 0;; text-align: center;">
							<a href="javascript:;" onclick="addProductToCart()">
