	...
	<head>
		...
		<script type="text/javascript">
			...
			function delCartItem(pid){
				if(confirm("你确认要删除该项吗？")){
					location.href="${pageContext.request.contextPath }/cart?method=delCartItem&pid="+pid;
				}
			}
							...
							<tbody>
								...
								<c:forEach items="${cart.cartItems }" var="entry">
									...
									<tr class="active">
										...
										<td>
											<a onclick="delCartItem('${entry.value.product.pid}')" href="javascript:;" class="delete">删除</a>
										</td>
									</tr>
